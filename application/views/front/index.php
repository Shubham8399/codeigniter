...
<?php } ?>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2019-20 E-SHOPPER Inc. All rights reserved.</p>
					<p class="pull-right">Develop by <span><a target="_blank" href="http://www.sumon-it.com">CubexO Software Solution</a></span></p>
				</div>
			</div>
		</div>
